...
<p align="center">
  <img src="docs/assets/benchmark-second-brain-v1.svg" width="920" alt="WikiBrain 벤치마크: 기능 검사 8개 중 8개 통과, 80회 회상에서 지연시간 p50 24.29밀리초와 p95 26.88밀리초">
</p>

커밋된 고정 corpus 벤치마크는 최근 문서 fallback을 끄고 query-only 검색을
실행합니다. 검색 결과가 기대한 근거를 포함하면서 폐기된 지침, 비밀정보,
다른 workspace의 내용을 제외해야만 통과합니다.

| 결과 | 값 |
| --- | ---: |
| 기능 검사 | **8/8 통과** |
| 회상 측정 | **80회** (query 4개 × 20회) |
| 지연시간 | **p50 24.29ms · p95 26.88ms** |
...
Apple Silicon macOS, Intel macOS, x86_64 Linux용 bottle을 제공합니다.
