...
지연시간은 **p50 24.29ms**, **p95 26.88ms**였습니다. 커밋된 기능 결과는
...
있습니다. CI는 corpus 버전, iteration 수, runner SHA-256, source manifest
SHA-256, Git commit, 생성 시각, 이식 가능한 재현 명령을 검증합니다.
