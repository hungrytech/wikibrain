...
def render_chart(result: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f'<desc id="desc">{passed} of {total} functional checks passed. Recall latency was {p50:.2f} milliseconds p50 and {p95:.2f} milliseconds p95 across {samples} samples.</desc>',
        ...
        _text(40, 108, "Fixed synthetic corpus · query-only retrieval", size=14, fill="#8fa3b8"),
